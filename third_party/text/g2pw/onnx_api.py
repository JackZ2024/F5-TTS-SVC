...
def download_and_decompress(model_dir: str = "G2PWModel/"):
    if not os.path.exists(model_dir):
        ...
        hf_url = "https://huggingface.co/xiaooowen/gpt-sovits/resolve/0fed1c2123dee00d1615934759089aa95ae26f0f/G2PWModel_1.1.zip"  # "https://paddlespeech.cdn.bcebos.com/Parakeet/released_models/g2p/G2PWModel_1.1.zip"
